const pages = ['inicio', 'lore', 'razas', 'oficios', 'gremios', 'gremio-aventuras', 'normativa', 'historia', 'deidades', 'raza-humano', 'raza-elfo', 'raza-enano', 'raza-shazari', 'raza-ossalyth', 'raza-malvakari', 'raza-thaetirs', 'raza-mestizo', 'oficio-galeno', 'oficio-herrero', 'oficio-minero', 'oficio-tabernero', 'oficio-joyero', 'oficio-artesano', 'oficio-granjero', 'oficio-guardia', 'oficio-alquimia', 'oficio-sastre', 'oficio-cazador', 'norm-general', 'norm-concepto', 'norm-ic', 'norm-construccion', 'norm-heridas', 'norm-combate', 'norm-esclavitud', 'norm-robo', 'norm-mazmorra', 'norm-housing', 'clases', 'clase-ciudadano', 'clase-vhark-hul', 'clase-argent-praetor', 'clase-dualhar', 'clase-luminari-vox', 'clase-noc-thar', 'clase-stormheilm', 'clase-velum-caedis', 'clase-velum-cantoris', 'clase-zereth-mor', 'clase-magharyn', 'clase-desconocido'];
