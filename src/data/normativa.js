export const normativaData = {
  ...
  pvp: {
    ...
    introGlow: '#b83a42',
    breadcrumb: 'PvP',
    intro: `<blockquote class="norm-quote">En Primus el conflicto es inevitable, tanto contra el entorno como entre sus propios habitantes. Estas tierras son peligrosas, y el PvP estará siempre abierto para aquellos que deseen resolver cualquier situación por medidas menos diplomáticas.<br/><br/>Por este motivo, especificaremos ciertas reglas y procedimientos para asegurarnos de que las cosas no se salgan de la mano y siempre exista el fair play.</blockquote>`,
    sections: [
      {
        ...
        text: 'El PvP es abierto de forma libre. Si un jugador desea abrir PvP deberá declararlo, adjuntando igualmente su tirada de iniciativa, pero siempre con un rol justificativo del porqué se está abriendo PvP.<br/><br/>Una vez declarada la apertura de PvP, los jugadores deberán pactar si el combate será hecho a Redux o a motor. En caso de desacuerdo, el método predeterminado será siempre Redux.<br/><br/>El ganador del combate decidirá las consecuencias del derrotado, pudiendo ser este último víctima de robo de monedas, objetos u otras consecuencias que se describirán a continuación.<br/><br/>Si el atacante es un personaje maldito, y por las mecánicas asociadas a estos personajes en particular, el CK estará abierto mutuamente. El combate necesariamente tiene que terminar en la muerte de uno de los combatientes.<br/><br/>Sin CK autorizado por la administración, solo se validarán heridas T2 a los participantes.',
      },
      {
        label: 'Huida',
        type: 'info',
        icon: 'lightning-bolt',
        title: 'Huida',
        text: 'Si un jugador no quiere combatir, puede huir de la pelea utilizando su dado correspondiente frente a los enemigos con los que se ha iniciado el combate.<br/><br/>La tirada de huida es definitiva. Si es un éxito, el combate termina y el jugador abandona la escena.',
      },
      {
        label: 'Ingreso al combate de forma tardía',
        type: 'info',
        icon: 'eyeball',
        title: 'Ingreso al combate de forma tardía',
        text: 'Los jugadores que lleguen una vez comenzado el combate deben esperar dos (2) rondas completas para intervenir.<br/><br/>Durante esas rondas, los jugadores ya involucrados pueden decidir si continuar o huir.<br/><br/>Si escogen huir y tienen éxito en la tirada, los recién llegados no podrán impedir la huida.',
      },
      {
        label: 'Combate a motor',
        type: 'info',
        icon: 'spinning-sword',
        title: 'Combate a motor',
        text: 'El combate a motor se realizará únicamente con consentimiento mutuo de parte de todos los involucrados.<br/><br/>Cada jugador contará con tres (3) vidas por cada tier de heridas. Una vez alcanzado el T2 de heridas —6 muertes— el combate se detiene y se declara al vencedor.<br/><br/>Con un CK abierto y autorizado se llegará al CK en la muerte número trece (13) —3 vidas por tier de heridas y una muerte más después de llegar a T4—.',
      },
      {
        label: 'Final del combate',
        type: 'info',
        icon: 'skull',
        title: 'Final del combate',
        text: 'El sistema de heridas es automático. Sin embargo, justificándolo en ticket como combate PvP —con su rol correspondiente— las heridas se reasignarán como T2 por parte de un administrador mientras no exista un CK abierto.<br/><br/>El ganador del combate puede robar uno (1) de los siguientes:<br/><br/>• Objeto Redux legendario (si lo posee).<br/>• 1 objeto de Redux (buff).<br/>• 25% del total de dinero del derrotado.<br/><br/>En caso de iniciar el combate con heridas abiertas de T2, el final del combate resultará en una herida T3, incrementándose en un tier por cada nivel superior a este.<br/><br/>Reiterando: si hay un personaje maldito involucrado en el combate, la consecuencia es un CK para el perdedor. Más allá de eso, habrán indicaciones adicionales para el maldito según su maldición.',
      },
      {
        label: 'Combates de entrenamiento',
        type: 'info',
        icon: 'castle-flag',
        title: 'Combates de entrenamiento',
        text: 'Habrán zonas designadas por el mapa para realizar combates de entrenamiento seguros. En estas zonas, el sistema de heridas no aplicará y podrán llegar a 0 HP de forma segura.<br/><br/>Estas zonas estarán ubicadas en cada centro de rol principal, como lo son la ciudad de Ash\u2019torin —en el gremio de aventuras— y las zonas de clase.',
      },
    ],
  },
  housing: {
